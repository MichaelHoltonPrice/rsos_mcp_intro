...
Once you have **R** and/or **RStudio** opened, install the *R* package `yada`, which will install additional dependencies:
...
Please refer to the file *MCP_Quick_Ref.doc* in this repository for a description and structure of each mean and noise equation. 
...
* TC_Oss - Tarsal count
* max_M1 - maxillary first molar development
* man_I2 - mandibular second incisor development

``` r
source("solvey_US_multivariate.R")
```

## 5. Do the multivariate cross-validation
...
Please refer to the "MCP_Quick_Ref" PDF document for detailed information on script changes for new data and/or analyses, and for ways the MCP is made accessible to all users.
